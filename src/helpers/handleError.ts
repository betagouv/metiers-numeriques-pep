...
function handleError(error: any, path: string, ctx: Context): never
/**
 ...
 */
function handleError(error: any, path: string, isFinalOrCtx?: boolean | Context): any {
  ...
  if (isFinalOrCtx === undefined || isFinalOrCtx === false) {
    return undefined as never
  }

  if (isFinalOrCtx === true) {
